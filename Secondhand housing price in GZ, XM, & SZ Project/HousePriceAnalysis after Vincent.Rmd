...
house_price <- read.csv("~/University File/Year 3 Fall/MA308/Project/dat0.csv")
```
...
district_levels <- levels(house_price$district)
for (district in district_levels) {
  leaps <- regsubsets(danjia ~ .,
                    data = house_price[
                      house_price$district == district,
                      c("area", "hall", "room", "age", "danjia",
                        "floor","school","chaoxiang", "subway")])
  plot <- plot(leaps, scale="adjr2", main = paste("House price in", district))
  plots_list[[district]] <- plot
}
```

```{r}
boxplot(danjia ~ subway, data = house_price)
boxplot(danjia ~ school, data = house_price)
boxplot(danjia ~ chaoxiang, data = house_price)
boxplot(danjia ~ hall, data = house_price)
boxplot(danjia ~ floor, data = house_price)
```
...
qqPlot(lm(danjia ~ subway, data = house_price), simulate = TRUE, main= "Q−Q Plot", labels = FALSE)
bartlett.test(danjia ~ school, data = house_price)
outlierTest(aov(danjia ~ school, data = house_price))

qqPlot(lm(danjia ~ school, data = house_price), simulate = TRUE, main= "Q−Q Plot", labels = FALSE)
bartlett.test(danjia ~ school, data = house_price)
outlierTest(aov(danjia ~ school, data = house_price))

qqPlot(lm(danjia ~ area, data = house_price), simulate = TRUE, main= "Q−Q Plot", labels = FALSE)
bartlett.test(danjia ~ school, data = house_price)
outlierTest(aov(danjia ~ school, data = house_price))

qqPlot(lm(danjia ~ hall, data = house_price), simulate = TRUE, main= "Q−Q Plot", labels = FALSE)
bartlett.test(danjia ~ school, data = house_price)
outlierTest(aov(danjia ~ school, data = house_price))

qqPlot(lm(danjia ~ age, data = house_price),simulate = TRUE, main= "Q−Q Plot", labels = FALSE)
bartlett.test(danjia ~ school, data = house_price)
outlierTest(aov(danjia ~ school, data = house_price))

lambda <- BoxCox.lambda(house_price$danjia, lower=0)
y_transformed <- BoxCox(house_price$danjia, lambda)
qqPlot(lm(y_transformed ~ age, data = house_price),simulate = TRUE, main= "Q−Q Plot", labels = FALSE)
bartlett.test(danjia ~ school, data = house_price)
outlierTest(aov(danjia ~ school, data = house_price))
...
for(district in district_levels){
  boxplot(danjia ~ subway,
          data = house_price[house_price$district == district,
                             c("danjia","subway", "district")],
          main = paste("Boxplot of danjia in every subway data in", district))
  boxplot(danjia ~ school,
          data = house_price[house_price$district == district,
                             c("danjia","school", "district")],
          main = paste("Boxplot of danjia in every school data in", district))
}

direction_levels = levels(house_price$chaoxiang)
for(district in district_levels){
  boxplot(danjia ~ chaoxiang,
          data = house_price[house_price$district== district,
                             c("danjia","chaoxiang", "district")],
          main = paste("Boxplot of danjia in every direction in",
                       district)
          )
}
```
...
```{r}
for (district in district_levels) {
  data_district <- house_price[house_price$district == district, c("area", "hall", "room", "age", "danjia", "floor","school","chaoxiang", "subway")]

  print(district)
  anova1_district <- aov(danjia ~ subway, data = house_price)
  anova2_district <- aov(danjia ~ school, data = house_price)
  anova3_district <- aov(danjia ~ chaoxiang, data = house_price)
  print(summary(anova1_district))
...
library(car)
for (district in district_levels) {
  data_district <- house_price[house_price$district == district,
                               c("area", "hall", "room", "age", "danjia",
                                 "floor","school","chaoxiang", "subway")]

  print(district)
  qqPlot(lm(danjia ~ school, data = house_price), simulate = TRUE, main= "Q−Q Plot", labels = FALSE)
  print(bartlett.test(danjia ~ school, data = house_price))
  print(outlierTest(aov(danjia ~ school, data = house_price)))
  
  qqPlot(lm(danjia ~ chaoxiang, data = house_price), simulate = TRUE, main= "Q−Q Plot", labels = FALSE)
  print(bartlett.test(danjia ~ chaoxiang, data = house_price))
  print(outlierTest(aov(danjia ~ chaoxiang, data = house_price)))
}
```
...
print(district_levels)
for (district in district_levels) {
  data_district <- house_price[house_price$district == district,
                               c("area", "hall", "room", "age", "danjia",
                                 "floor","school","chaoxiang", "subway")]
  print(district)
  print(vif(danjia ~ ., data = data_district))
}
```
